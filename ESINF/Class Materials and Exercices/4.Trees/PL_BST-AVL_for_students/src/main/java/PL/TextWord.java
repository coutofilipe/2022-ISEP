...
public class TextWord implements Comparable<TextWord> {
    ...
    public TextWord(String word, int ocorrences) { setWord(word, ocorrences); }
    ...
    public int getOcorrences() { return ocorrences; }
    ...
    public String toString() { return "<" + word + ">:" + ocorrences; }
}
