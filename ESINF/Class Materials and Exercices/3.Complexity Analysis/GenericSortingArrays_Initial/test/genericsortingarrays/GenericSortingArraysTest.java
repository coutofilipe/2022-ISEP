...
public class GenericSortingArraysTest {
    ...
    /**
     * Test of bubbleSort method, of class GenericSortingArrays.
     */
    @Test
    public void testBubbleSort() {
        System.out.println("BubbleSort Order");

        checkOrder(GenericSortingArrays::bubbleSort);
    }
     ...
     */
    @Test
    public void testBubleSortTime() {
        System.out.println("SelectionSort Time");

        timeSort(GenericSortingArrays::bubbleSort, sizeSlow);
    }

    /**
     * Test of optimizedBubbleSort method, of class GenericSortingArrays.
     */
    @Test
    public void testOptimizedBubbleSort() {
        System.out.println("BubbleSort Order");

        checkOrder(GenericSortingArrays::optimizedBubbleSort);
    }
     ...
     */
    @Test
    public void testOptimezedBubleSortTime() {
        System.out.println("SelectionSort Time");

        timeSort(GenericSortingArrays::optimizedBubbleSort, sizeSlow);
    }
